...
function buildStyles(props, theme) {
  var margin = props.margin,
      ...
      restProps = _objectWithoutProperties(props, ['margin', 'marginHorizontal', 'marginVertical', 'marginBottom', 'marginLeft', 'marginRight', 'marginTop', 'padding', 'paddingHorizontal', 'paddingVertical', 'paddingBottom', 'paddingLeft', 'paddingRight', 'paddingTop', 'bottom', 'height', 'left', 'maxHeight', 'maxWidth', 'minHeight', 'minWidth', 'right', 'top', 'width', 'alignContent', 'alignItems', 'alignSelf', 'backgroundColor', 'borderWidth', 'borderBottomWidth', 'borderStyle', 'color', 'display', 'flex', 'flexBasis', 'flexDirection', 'flexGrow', 'flexShrink', 'flexWrap', 'justifyContent', 'opacity', 'overflow', 'position', 'zIndex', 'borderLeftWidth', 'borderRightWidth', 'borderTopWidth', 'borderRadius', 'borderBottomLeftRadius', 'borderBottomRightRadius', 'borderTopLeftRadius', 'borderTopRightRadius', 'borderColor', 'borderBottomColor', 'borderLeftColor', 'borderRightColor', 'borderTopColor']);

  return {
    style: _extends({}, getStyleValues({
...
function composeBoxStyles(props, theme) {
  var _buildStyles = buildStyles(props, theme),
      style = _buildStyles.style,
      restProps = _buildStyles.restProps;

  return { composedStyle: style, restProps: restProps };
}
