...
function buildBoxStyles(props, theme) {
  ...
  if (media) {
    ...
    var computedMediaStyles = Object.keys(mediaStyleDefinitions).reduce(function (mediaStyles, dimension) {
      ...
      mediaStyles[mediaD] = (0, _cssInJsUtils.assignStyle)(boxStyle.styles, boxStyle.restProps);
      return mediaStyles;
    }, {});

    composedStyles = (0, _cssInJsUtils.assignStyle)(styles, computedMediaStyles);
  }
